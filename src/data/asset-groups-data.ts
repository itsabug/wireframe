...
const systemGroups: AssetGroup[] = [
  ...
  // System groups under External Hosts
  createGroup({
    id: 'grp-known-threat-ips',
    name: 'Known Threat IPs',
    description: 'IP addresses from threat intelligence feeds associated with malicious activity',
    type: 'dynamic',
    source: 'system',
    status: 'active',
    parentId: 'grp-external',
    priority: 95,
    icon: 'alert',
    businessCriticality: 'not_important',
    rules: [{ field: 'tag', operator: 'contains', value: 'threat-intel' }],
    options: noBaselineOptions,
    assetCount: 23,
    isDefault: true,
  }),
  createGroup({
    id: 'grp-tor-exit-nodes',
    name: 'Tor Exit Nodes',
    description: 'Known Tor network exit nodes detected communicating with internal assets',
    type: 'dynamic',
    source: 'system',
    status: 'active',
    parentId: 'grp-external',
    ...
    icon: 'globe',
    businessCriticality: 'not_important',
    rules: [{ field: 'tag', operator: 'contains', value: 'tor-exit' }],
    options: noBaselineOptions,
    assetCount: 8,
    isDefault: true,
  }),

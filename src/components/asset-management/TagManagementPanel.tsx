  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Manage tags used for whitelisting, policy scoping, and asset categorization.
          </p>
        </div>
      ...
      <div className="flex items-center justify-between pt-2">
        <div>
          <h3 className="text-lg font-semibold text-foreground">Auto-Tag Rules</h3>
          <p className="text-sm text-muted-foreground mt-1">
            Automatically apply tags using packet-level attributes observed by the NDR sensors.
          </p>
        </div>
        <Button variant="outline" onClick={handleStartRuleCreate}>
          <Plus className="w-4 h-4 mr-2" />
          Add Auto-Tag Rule
        </Button>
      </div>
        ...
        <div className="border border-primary/50 rounded-lg p-4 space-y-4 bg-primary/5">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              {newRule.conditions.map((condition, index) => (
                <div key={condition.id} className="grid gap-2 md:grid-cols-[200px_160px_1fr_auto]">
                  <Select
                  ...
                  <div className="space-y-1">
                    ...
                    {condition.operator === 'matches_regex' && (
                      <p className="text-[11px] text-muted-foreground">
                        ...
                        <span className="font-mono">^10\\.0\\..*$</span> matches any 10.0.* value.
                      </p>
                    )}
                  </div>
                  <Button
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              disabled={!newRule.name.trim() || !newRule.tag.trim()}
            >
              Save Rule
            </Button>
          </div>
                  ...
                  <TableCell className="text-right">
                    <div className="flex justify-end gap-1">
                      ...
                      <Button
                        ...
                        className="text-muted-foreground hover:text-destructive"
                        onClick={() =>
                          setAutoTagRules((prev) => prev.filter((item) => item.id !== rule.id))
                        }
                      >
                        <Trash2 className="w-4 h-4" />
                      </Button>
